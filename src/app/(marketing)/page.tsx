    ...
    <header className={cn(
      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link href="/login" className="inline-flex items-center gap-2 bg-[#FA7866] hover:bg-[#E55C49] text-white text-sm font-bold px-5 py-2.5 rounded-xl transition-colors shadow-sm shadow-[#FA7866]/30">
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white pt-16">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-[#FA7866]/8 rounded-full blur-3xl" />
        <div className="absolute top-1/2 -left-32 w-[400px] h-[400px] bg-[#FA7866]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-[300px] h-[300px] bg-blue-50 rounded-full blur-3xl" />
      </div>

      <div className="max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        {/* Left */}
        <div>
          <div className="inline-flex items-center gap-2 bg-[#FFF1EF] text-[#FA7866] text-xs font-bold px-3.5 py-1.5 rounded-full mb-6 border border-[#FA7866]/20">
            <Zap className="w-3.5 h-3.5" strokeWidth={2} />
            Nouveau · Rapports en temps réel
          </div>

          <h1 className="text-[52px] leading-[1.08] font-extrabold text-gray-900 tracking-tight mb-6">
            Pilotez votre hôtel{" "}
            <span className="relative inline-block">
              <span className="relative z-10 text-[#FA7866]">en temps réel.</span>
          ...
          <p className="text-[18px] text-gray-500 leading-relaxed mb-8 max-w-lg">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-10">
            <Link href="/login" className="inline-flex items-center gap-2 bg-[#FA7866] hover:bg-[#E55C49] text-white font-bold px-7 py-4 rounded-2xl transition-all shadow-lg shadow-[#FA7866]/25 hover:shadow-xl hover:shadow-[#FA7866]/30 hover:-translate-y-0.5">
              Démarrer gratuitement
              <ArrowRight className="w-5 h-5" strokeWidth={2} />
            </Link>
            <a href="#demo" className="inline-flex items-center gap-2 text-gray-600 font-semibold hover:text-gray-900 transition-colors">
        ...
        <div className="relative">
          <div className="relative bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-5 bg-[#F5F5F5] min-h-[380px]">
              ...
              <div className="grid grid-cols-4 gap-2 mb-4">
                {[
                  { label: "Occupées", value: "24", color: "text-blue-600", bg: "bg-blue-50" },
                  { label: "Disponibles", value: "8", color: "text-green-600", bg: "bg-green-50" },
                  { label: "Nettoyage", value: "5", color: "text-amber-600", bg: "bg-amber-50" },
                  { label: "Urgentes", value: "2", color: "text-[#FA7866]", bg: "bg-[#FFF1EF]" },
                ].map((s) => (
                  <div key={s.label} className="bg-white rounded-xl p-3 shadow-sm">
                    <div className={cn("w-6 h-6 rounded-lg flex items-center justify-center mb-2", s.bg)}>
                      <div className={cn("w-2.5 h-2.5 rounded-full", s.color.replace("text-", "bg-"))} />
                    </div>
              ...
              <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-3">
                <div className="px-3 py-2 border-b border-gray-50 flex items-center justify-between">
                  ...
                  <span className="text-[10px] bg-[#FFF1EF] text-[#FA7866] font-bold px-1.5 py-0.5 rounded-full">3 urgentes</span>
                </div>
                {[
              ...
              <div className="bg-white rounded-xl shadow-sm p-3">
                ...
                <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-[#FA7866] rounded-full" style={{ width: "78%" }} />
                </div>
          ...
          {/* Floating badges */}
          <div className="absolute -left-6 top-1/3 bg-white rounded-2xl shadow-xl border border-gray-100 px-4 py-3 flex items-center gap-2.5 animate-bounce" style={{ animationDuration: "3s" }}>
          ...
          <div className="absolute -right-4 bottom-1/4 bg-white rounded-2xl shadow-xl border border-gray-100 px-4 py-3 flex items-center gap-2.5" style={{ animation: "bounce 4s infinite 1.5s" }}>
    ...
    <section className="border-y border-gray-100 bg-gray-50 py-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-10 opacity-40">
          {["Grand Hôtel", "Les Bains", "Résidence du Parc", "Château Blanc", "Villa Mer"].map((name) => (
            <span key={name} className="text-lg font-extrabold text-gray-700 tracking-tight">{name}</span>
          ))}
        </div>
      </div>
    </section>
    ...
    <section className="py-28 bg-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Old way */}
          <div className="rounded-3xl border-2 border-red-100 bg-red-50/50 p-8">
          ...
          {/* With HotelHive */}
          <div className="rounded-3xl border-2 border-[#FA7866]/20 bg-[#FFF1EF]/40 p-8">
...
const FEATURES = [
  {
    ...
    title: "Statut des chambres en direct",
    desc: "Suivez chaque chambre en temps réel. Disponible, occupée, nettoyage, maintenance — tout est visible en un coup d'œil.",
  },
  {
    icon: ClipboardList,
    color: "bg-[#FFF1EF] text-[#FA7866]",
    title: "Gestion des tâches",
    desc: "Créez, assignez et suivez les tâches de votre équipe. Vue kanban ou liste, avec priorités et délais.",
  },
  {
    icon: Wrench,
    color: "bg-amber-50 text-amber-600",
    title: "Maintenance intégrée",
    desc: "Tickets de maintenance directement liés aux chambres. L'équipe reçoit une notification immédiate sur son téléphone.",
  },
  {
    icon: Bell,
    color: "bg-purple-50 text-purple-600",
    title: "Notifications en temps réel",
    desc: "Chaque changement d'état déclenche une alerte à la bonne personne. Fini les oublis, fini les retards.",
  },
  {
    icon: BarChart3,
    color: "bg-green-50 text-green-600",
    title: "Rapports & analytics",
    desc: "Performance par employé, par département, par période. Exportez en CSV pour vos réunions d'équipe.",
  },
  {
    icon: Smartphone,
    color: "bg-sky-50 text-sky-600",
    title: "Application mobile PWA",
    desc: "Votre staff accède à ses tâches depuis n'importe quel smartphone. Sans installation, directement depuis le navigateur.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FEATURES.map(({ icon: Icon, color, title, desc }) => (
            <div key={title} className="bg-white rounded-3xl p-7 border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
              <div className={cn("w-12 h-12 rounded-2xl flex items-center justify-center mb-5", color)}>
                <Icon className="w-6 h-6" strokeWidth={1.5} />
              </div>
              <h3 className="text-[17px] font-extrabold text-gray-900 mb-2 group-hover:text-[#FA7866] transition-colors">{title}</h3>
...
const STEPS = [
  {
    num: "01",
    icon: BedDouble,
    title: "Sélectionnez une chambre et changez son statut",
    desc: "Le manager ou la réception indique qu'une chambre nécessite un nettoyage ou une maintenance directement depuis le tableau de bord.",
    badge: "Temps réel",
  ...
  },
  {
    num: "02",
    icon: Users,
    title: "La tâche est assignée automatiquement",
    desc: "HotelHive sélectionne le membre du personnel le moins chargé et lui envoie une notification immédiate sur son téléphone.",
    badge: "Automatique",
    badgeColor: "bg-[#FFF1EF] text-[#FA7866]",
  },
  {
    num: "03",
    icon: CheckCircle2,
    title: "Le staff complète et confirme",
    desc: "Le personnel valide la tâche depuis son téléphone, ajoute des photos si besoin, et la chambre passe automatiquement en disponible.",
    badge: "Mobile",
  ...
  },
  {
    num: "04",
    icon: Shield,
    title: "Le statut se met à jour pour tous",
    desc: "En temps réel, tout le monde voit la chambre disponible. La réception peut immédiatement attribuer la chambre au prochain client.",
    badge: "Instantané",
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-4">
          {STEPS.map(({ num, icon: Icon, title, desc, badge, badgeColor }, i) => (
            <div key={num} className="flex items-start gap-6 bg-gray-50 rounded-3xl p-6 border border-gray-100 hover:border-[#FA7866]/20 hover:bg-[#FFF1EF]/20 transition-all group">
              <div className="flex flex-col items-center gap-2 shrink-0">
                <div className="w-12 h-12 rounded-2xl bg-white border border-gray-200 flex items-center justify-center shadow-sm group-hover:border-[#FA7866]/30 transition-colors">
                  <Icon className="w-5 h-5 text-gray-500 group-hover:text-[#FA7866] transition-colors" strokeWidth={1.5} />
                </div>
...
const TESTIMONIALS = [
  {
    name: "Sophie Martin",
    role: "Directrice, Hôtel Belle Époque",
    avatar: "SM",
    color: "bg-blue-100 text-blue-700",
    stars: 5,
    quote: "Depuis HotelHive, nos délais de nettoyage ont été réduits de 40%. L'équipe adore recevoir ses tâches directement sur le téléphone.",
  },
  {
    name: "Karim Benali",
    role: "Manager, Résidence du Parc",
    avatar: "KB",
    color: "bg-amber-100 text-amber-700",
    stars: 5,
    quote: "La page rapports m'a permis d'identifier nos bottlenecks en 10 minutes. J'aurais mis des semaines avec Excel.",
  },
  {
    name: "Claire Dumont",
    role: "Responsable exploitation, Grand Hôtel",
    avatar: "CD",
    color: "bg-[#FFF1EF] text-[#FA7866]",
    stars: 5,
    quote: "L'interface est tellement claire que mon équipe a été autonome dès le premier jour. Zéro formation nécessaire.",
  },
];
    ...
    <section className="py-28 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map(({ name, role, avatar, color, stars, quote }) => (
            <div key={name} className="bg-white rounded-3xl p-7 border border-gray-100 hover:shadow-lg transition-all">
...
const PLANS = [
  ...
  },
  {
    name: "Pro",
    price: "89",
    desc: "Pour les hôtels qui veulent performer",
    color: "border-[#FA7866]",
  ...
  },
  {
    name: "Enterprise",
    price: "Sur mesure",
    desc: "Pour les groupes hôteliers",
    color: "border-gray-200",
    badge: null,
    features: [
  ...
  return (
    <section className="py-28 bg-white" id="tarifs">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PLANS.map(({ name, price, desc, color, badge, features }) => (
            <div key={name} className={cn("relative rounded-3xl border-2 p-7 flex flex-col", color, badge ? "bg-[#FFF8F7] shadow-xl shadow-[#FA7866]/10" : "bg-white")}>
              {badge && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#FA7866] text-white text-[11px] font-bold px-4 py-1.5 rounded-full whitespace-nowrap">
                  {badge}
                </div>
              )}
              <div className="mb-6">
              ...
              <Link
                href="/login"
                className={cn(
                  "inline-flex items-center justify-center gap-2 py-3.5 rounded-2xl text-sm font-bold transition-all",
                  badge
                    ? "bg-[#FA7866] hover:bg-[#E55C49] text-white shadow-md shadow-[#FA7866]/25"
        ...
        <div className="relative bg-[#FA7866] rounded-[40px] overflow-hidden px-12 py-16 text-center">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/login" className="inline-flex items-center gap-2 bg-white text-[#FA7866] font-extrabold px-8 py-4 rounded-2xl hover:bg-gray-50 transition-all shadow-xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              La plateforme de gestion hôtelière pensée pour les équipes modernes.
            </p>
          </div>
          {[
