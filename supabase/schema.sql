...
-- ============================================================
-- 5. TASK TEMPLATES (recurring task definitions)
-- ============================================================
...
-- ============================================================
-- 6. ROOM ORDERS (front office client requests)
-- ============================================================
...
CREATE TABLE notifications (
  ...
  user_id    UUID        NOT NULL REFERENCES profiles(id) ON DELETE CASCADE,
  type       TEXT        NOT NULL
                         CHECK (type IN ('task_assigned', 'urgent', 'completed', 'task_late', 'room_ready', 'issue_reported', 'note_added')),
  title      TEXT        NOT NULL,
